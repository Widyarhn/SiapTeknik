                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Rekapitulasi Penilaian Asesmen {{$program_studi->nama}} </h1>
                        ...
                        <div class="section-body">
                            ...
                            <p class="section-lead">Rekapitulasi penilaian Asesmen ini diambil berdasarkan borang sebelum survei lapangan </p>
                            ...
                            {{-- <div class="row">
                                ...
                                <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h4>Tabel Rekap Penilaian Asesmen {{$program_studi->nama}}</h4>
                                                    </div>
                                                    <div class="card-body">
                                    ...
                                    @else
                                    <h1>Akreditasi tahun {{$user_asesor->tahun->tahun}} program studi {{$program_studi->jenjang->jenjang}} {{$program_studi->nama}} telah selesai, silahkan lihat di history</h1>
                                    @endif
                                    <!--Basic table-->
                                </div>
                            </section>
                        ...
                        <div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('rekap-nilaid3.store')}}" method="post" enctype="multipart/form-data" id="formActionTambah">
                                        @csrf
                                        @method('POST')
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6 mb-1">
                                                                ...
                                                                <input type="date" name="tanggal_batas" class="form-control" id="category">
                                                            </div>
                                                            <div class="col-6 mb-1">
                                                                <label class="form-label">Tanggal Penilaian</label>
                                                                <input type="date" name="tanggal_penilaian" class="form-control" id="stock_item">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                    ...
                    <script>
                        $(function() {
                            $('#rekapTable').dataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{ route('rekap-nilaid3.jsonAkhir', $program_studi->id) }}",
                                columns: [{
                                    data: 'DT_RowIndex',
                                    name: 'DT_RowIndex',
                                },
