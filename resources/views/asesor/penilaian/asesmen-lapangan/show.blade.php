                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Penilaian Asesmen Lapangan {{$program_studi->jenjang->jenjang}} {{$program_studi->nama}}</h1>
                            <div class="section-header-breadcrumb">
                                <div class="breadcrumb-item active"><a href="{{ url('dashboard-asesor') }}">Dashboard</a></div>
                                <div class="breadcrumb-item">Asesmen Lapangan {{$program_studi->jenjang->jenjang}} {{$program_studi->nama}}</div>
                            </div>
                        </div>
                        @if ($errors->any())
                        ...
                        <div class="section-body">
                            ...
                            <div class="card">
                                <div class="card-header d-block pb-0">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <a href="{{route('nilai-asesmenlapangan.elemen', $program_studi->id)}}" class="btn btn-outline-secondary">
                                                            ...
                                                            <table class="table table-striped table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <form action="{{ route('nilai-asesmenlapangan.store') }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                                            @csrf
                                                                            @method('POST')
                                                                            <tr>
                                                                                <th>
                                                                                ...
                                                                                @if(count($data->asesmen_lapangan)>0)
                                                                                <td>
                                                                                    <input type="hidden" id="" />
                                                                                    <input type="text" placeholder="1-4" name="nilai" value=" {{$data->asesmen_lapangan[0]->nilai}}" class="form-control text-center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="deskripsi" class="form-control">
                                                                        {{$data->asesmen_lapangan[0]->deskripsi}}
                                                                    </textarea>
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                @if(count($data->asesmen_lapangan)>0)
                                                                <form action="{{route('nilai-asesmenlapangan.update', $data->asesmen_lapangan[0]->id)}}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                                    @csrf
                                                                    @method('PUT')
                                                                <tr>
                                                                    <th> 
                                                                ...
                                                                ') }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                                    @csrf
                                                                    @method('POST')
                                                                    <tr>
                                                                        <th> 
