        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @php
                                                $lkps = Lkps::where("program_studi_id", $item_tahun->program_studi_id)->where("tahun_id", $item_tahun->tahun_id)->first();
                                                $led = Led::where("program_studi_id", $item_tahun->program_studi_id)
                                                    ->where("tahun_id", $item_tahun->tahun_id)
                                                    ->first();
                                                @endphp
                                                @if (empty($lkps))
                                                <form action="{{ route('ajuan-prodi.storelkps') }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                    @csrf
                                                    @method('POST')
                                                    <input type="hidden" value="{{ $item_tahun->program_studi_id }}" name="program_studi_id" />
                                                    <input type="hidden" value="{{ $item_tahun->tahun->id }}" name="tahun_id" />
                                                ...
                                                @else
                                                <form action="{{ route('ajuan-prodi.updatelkps', $item_tahun->tahun->lkps[0]->id) }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                    @csrf
                                                    @method('POST')
                                            ...
                                            <td>
                                                ...
                                                @else
                                                <a href="{{url('storage/dokumen_prodi/', $lkps->file)}}" target="_blank">{{$lkps->file}}</a>
                                                @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if (empty($led))
                                                <form action="{{ route('ajuan-prodi.storeled') }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                    @csrf
                                                    @method('POST')
                                                    <input type="hidden" value="{{ $item_tahun->program_studi_id }}" name="program_studi_id" />
                                                    <input type="hidden" value="{{ $item_tahun->tahun->id }}" name="tahun_id" />
                                                ...
                                                @else
                                                <form action="{{ route('ajuan-prodi.updateled', $item_tahun->tahun->led[0]->id) }}" method="post" enctype="multipart/form-data" id="formActionStore">
                                                    @csrf
                                                    @method('POST')
                                            ...
                                            <td>
                                                ...
                                                Belum ada file yang diupload
                                                @else
                                                <a href="{{url('storage/dokumen_prodi/', $led->file)}}" target="_blank">{{$led->file}}</a>
                                                @endif
                    ...
                    @else
                    <h1>Akreditasi pada tahun {{$item_tahun->tahun->tahun}} telah selesai, silahkan lihat history akreditasi</h1>
                    @endif
                    @endforeach
                </div>
            </section>
