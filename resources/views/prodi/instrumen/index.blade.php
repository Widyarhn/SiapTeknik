...
<head>
    ...
    <title>Instrumen Akreditasi &rsaquo; {{$jenjang->jenjang}}</title>
    @include('body')
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">Instrumen {{$jenjang->jenjang}}</div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Program Pendidikan {{$jenjang->jenjang}}</h4>
                                    </div>
                                    <div class="card-body">
        ...
        <script>
            $(function() {
                $('#instrumenTable').dataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('prodi.instrumen.json', $jenjang->id) }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                        },
