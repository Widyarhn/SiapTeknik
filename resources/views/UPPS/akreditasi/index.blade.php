                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <div class="row ">
                            <div class="col-12">
                                <form id="setting-form">
                                    @foreach ($timeline as $item_tahun)
                                        <div class="card">
                                            @if ($item_tahun->status == 1)
                                                <div class="card-header"
                                                    ...
                                                    <div class="card-header-action">
                                                        <a href="#" data-toggle="modal"
                                                            ...
                                                            style="border-radius: 30px;"><i
                                                                class="fas fa-user-plus"></i> Penugasan Asesor</a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">
                                                                {{ $item_tahun->program_studi->jenjang->jenjang }}
                                                                {{ $item_tahun->program_studi->nama }} |
