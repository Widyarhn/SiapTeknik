            ...
            <div class="main-content">
                ...
                @endif
                    <div class="section-body">
                        ...
                        <p class="section-lead">Informasi User Program Studi Jenjang {{$jenjang->jenjang}} atau pengguna aplikasi Lingkup INFOKOM</p>
                        <!--Basic table-->
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
        ...
        {{-- <div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('UPPS.user-prodi.store')}}" method="post" enctype="multipart/form-data" id="formActionTambah">
                        @csrf
                        @method('POST')
