            ...
            <div class="main-content">
                ...
                @endif
                    <div class="section-body">
                        ...
                        <p class="section-lead">Informasi User Asesor Jenjang {{$jenjang->jenjang}} atau pengguna aplikasi Lingkup INFOKOM</p>
                        <!--Basic table-->
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah User Asesor Jenjang {{$jenjang->jenjang}}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{route('UPPS.user.store')}}" method="post" enctype="multipart/form-data" id="formActionTambah">
                        @csrf
                        @method('POST')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="program_studi" class="form-control selectric" name="program_studi_id">
                                                ...
                                                <option value="{{ $program_studi->id }}">{{$program_studi->jenjang->jenjang}} {{ $program_studi->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        {{-- {{$jenjang->id}} 
